...
class kilpailuntiedot {
    ...
    public static function getkilpailut() {
        $sql = "SELECT * from kilpailu  ORDER BY paivamaara";
        $kysely = getTietokantayhteys()->prepare($sql);
        $kysely->execute();
    ...
    public function updatekilpailu() {
        ...
        $kysely = getTietokantayhteys()->prepare($sql);
        $ok = $kysely->execute(array($this->paivamaara, $this->nimi, $this->tunnus, $this->salasana, $this->id));
    ...
    public function etsi($id) {
        ...
        if ($tulos == null) {
            ...
            $kilpailu = new kilpailuntiedot($tulos->id, $tulos->paivamaara, $tulos->nimi, $tulos->tunnus, $tulos->salasana);
